                ...
                <div className="modal-content">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="modal-body d-flex flex-column gap-3">
                            <div className="d-flex flex-wrap gap-3">
                                ...
                                <div className="flex-fill">
                                    ...
                                    <input type="text" className="form-control" id="middleName" value={formData.middleName || ""}
                                        onChange={handleChange} placeholder='Enter middle name' />
                                </div>
                                <div className="flex-fill">
                            ...
                            <div className="d-flex flex-wrap gap-3">
                                ...
                                <div className="flex-fill">
                                    ...
                                    <input type="date" className="form-control" id="dateOfBirth" value={formatDateForInput(formData.dateOfBirth) || ""}
                                        onChange={handleChange} placeholder='Enter date of birth' />
                                </div>
                                <div className='flex-fill'>
                                    <label htmlFor='ministry' className='form-label'>Ministry</label>
                                    <input type="text" className="form-control" id="ministry" value={formData.ministry || ""}
                                        onChange={handleChange} placeholder='Enter ministry' />
                                </div>
                                <div className="flex-fill w-100">
                                    <label htmlFor="address" className="form-label">Address</label>
                                    <input type="text" className="form-control" id="address" value={formData.address || ""}
                                        onChange={handleChange} required placeholder='Enter address' />
                                </div>
                            </div>
                            ...
                            <div className="d-flex flex-wrap gap-3">
                                ...
                                <div className="flex-fill">
                                    ...
                                    <input type="number" className="form-control" id="contactNo" value={formData.contactNo || ""}
                                        onChange={handleChange} placeholder='Enter contact number' />
                                </div>
                            </div>
                        ...
                        <div className="modal-footer d-flex">
                            ...
                            <button type="button" className="btn btn-secondary btn-Close" onClick={handleClose} data-bs-dismiss="modal">Cancel</button>
