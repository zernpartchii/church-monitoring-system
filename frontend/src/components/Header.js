    ...
    return (
        <div className='p-2 sticky-top topbar '>
            <div className='center gap-2 px-2 topNav my-2'>
                <span className="material-symbols-outlined actionButtons cursor p-1 menu" onClick={handleMenuToggle}>
                    left_panel_close
                </span>
                <NavLink className='center text-decoration-none p-1 actionButtons cursor notif position-relative' to={"/cms/notifications"}>
                    <span className="material-symbols-outlined">
                        notifications
                    </span>
                    <span className="position-absolute top-0 start-100 translate-middle badge bg-danger notifBadge">0</span>
                </NavLink>
